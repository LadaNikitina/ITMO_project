...
6. Разработка базы данных для хранения данных
...
7. Автоматизация процессов: оформление пунктов 1, 2 и 5 в отдельный пайплайн для автоматизации
...
8. Оформление дашборда - демовидео дашборда представлено по [ссылке](https://drive.google.com/file/d/1lIcieReKksGiEPCOzh9ErQCFNrK0zU1d/view?usp=sharing)
...
9. Создание презентации и пояснительной записки о работе
